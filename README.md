...
> **進階版本提示 (Advanced Version Notice)**
> 本 main 分支展示的是系統的經典底層架構 (Java EE/Servlet/JSP)。
> 若想查看全面重構後的現代化微服務版本（採用 Spring Boot 4.0.5 + Java 21，具備 RESTful API、DTO 封裝與前後端分離架構），請切換至 dev-1 分支查看。
...
2. 填寫你的本機資料庫連線資訊：
   ...
   jdbc.password=你的密碼
   ```
   *(注意：config.properties 建議加入 .gitignore，請勿將自己的密碼推上遠端！)*
